Rails.application.routes.draw do
  ...
  # Support optional locale parameter for all routes
  # Accept 2-letter locale codes and locale codes with region (e.g., zh-CN, zh-TW)
  scope "(:locale)", locale: /[a-z]{2}(-[A-Z]{2})?/ do
    # Mount the engine (admin routes will be at /:locale/moderation/admin/image_reports)
